...
public class Basic {
    ...
    같은 스코프(scope) 안에서는 (같은 블록 안에서는) 같은 이름의 변수 선언은 최초 한 번만 한다.
    int num;
    float num2;
    ...
    변수명 센스
    - 의미가 있는 이름을 사용하는게 좋다. (Ex. 최악: a, b, c)
    - 너무 길지 않도록 (Ex. desc: description, name: nm, class: cls ..etc)
    */
